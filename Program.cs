                ...
                while (true)
                {
                    try
                    {
                        ...
                        else
                        {
                            ...
                            {
                                Console.WriteLine("Erro ao puxar o proxy...");
                            }
                            if (HaveCookie(conta.Conta.Username))
                            {
                                ...
                                Insta i = new(conta.Conta.Username.ToLower(), conta.Conta.Password, data[0], data[2], $"http://{proxy.IP}:{proxy.Port}/", proxy.User, proxy.Pass);
